...
LogDebug("GenerateIntentMatchingScore_SpecifiedIntent", intent.type,'\r\n');
    var url = matchData.url;
    var title = matchData.title;
    var snippet = matchData.snippet;
...
LogDebug("GenerateIntentMatchingScore Begin", '\r\n');
