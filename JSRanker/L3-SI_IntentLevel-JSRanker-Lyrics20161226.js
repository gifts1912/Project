...
function MainRanker(subIntentId, subIntentScore, MSSFDecodeResult, matchDataArray, intentMatchCondition, constraintMatchCondition, documentsLocal, documentCount) {
	...
	for (i = 0; i < top20doc; ++i) {
		...
		if (i == 0){
            ...
            GenerateIntentSpanWords(intentOther, intentMajor, clusterId, MSSFDecodeResult.intent);
            ...
            var intentMatchScore = GenerateIntentMatchingScore(intentOther, intentMajor, matchData);//intentMajor contens the span words of int_tag that come from clusterId; intentOther: contains a. span words of the int_tag that generate in slot tagger. b. Keywords of int_tag that generate from slot_tag.
			//var intentMatchScore = GenerateIntentMatchingScore(intentMatchCondition, MSSFDecodeResult.intent, matchData, topSiteScoreResult.isIntent);
